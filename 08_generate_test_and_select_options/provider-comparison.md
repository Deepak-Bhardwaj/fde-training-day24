...
## Upstream dependency
Use the completed Stage 07 artifacts and explicitly referenced earlier artifacts. Never copy them into this file simply to satisfy a checklist.
...
- `reference_material/Technology_Option_Catalog.md`

## Case challenge
Provider capabilities and prices change. If you use vendor-specific claims, record source and date; otherwise compare capability classes.
...
## Working scaffold
| Provider/class | Capability fit | Security/governance | Latency/cost evidence | Exit/reversibility | Source/date | Decision |
|---|---|---|---|---|---|---|
|  |  |  |  |  |  |  |
