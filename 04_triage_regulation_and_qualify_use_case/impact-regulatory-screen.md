...
- External claim/source if used
- Open legal assumption
...
## Working scaffold
| Intended use | Affected party/process | Impact | Internal requirement | External claim/source if used | Open legal assumption |
|---|---|---|---|---|---|
|  |  |  |  |  |  |
